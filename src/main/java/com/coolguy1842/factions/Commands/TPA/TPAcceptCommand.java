...
public class TPAcceptCommand {
    ...
    public static void register(CommandManager<CommandSender> commandManager) {
        commandManager.command(
            commandManager.commandBuilder("tpaccept")
    ...
    public static void runCommand(CommandContext<CommandSender> ctx) {
        ...
        case TPA: PlayerUtil.teleportPlayer(sender, player.getLocation()); break;
        case TPAHERE: PlayerUtil.teleportPlayer(player, sender.getLocation()); break;
        default: break;
        }

        TPAManager.getInstance().removeRequest(player.getUniqueId());

        player.sendMessage(MessageUtil.format("{} You accepted the request from {}!", Factions.getPrefix(), PlayerUtil.playerGlobalName(sender)));
        sender.sendMessage(MessageUtil.format("{} {} accepted the teleport request!", Factions.getPrefix(), PlayerUtil.playerGlobalName(player)));
    }
}
