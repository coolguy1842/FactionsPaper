...
public class PlayerManager {
    ...
    public FactionPlayer addPlayer(UUID id) {
        assertThat(id).isNotNull().withFailMessage("PlayerManager#addPlayer failed: id == null");

        Optional<FactionPlayer> player = database.addPlayer(id, 0L, null, null);
        assertThat(player).isPresent().withFailMessage("PlayerManager#addPlayer failed: player with UUID: %s not created.", id);
    ...
    public List<FactionPlayer> getPlayersWithFaction(UUID faction) {
        assertThat(faction).isNotNull().withFailMessage("PlayerManager#getPlayersWithFaction failed: faction == null");
    ...
    public List<FactionPlayer> getPlayersWithRank(UUID rank) {
        assertThat(rank).isNotNull().withFailMessage("PlayerManager#getPlayersWithRank failed: rank == null");
    ...
    public Optional<FactionPlayer> getPlayer(UUID id) {
        assertThat(id).isNotNull().withFailMessage("PlayerManager#getPlayer failed: id == null");
    ...
    public void setPlayerBalance(UUID id, Long balance) {
        assertThat(id).isNotNull().withFailMessage("PlayerManager#setPlayerBalance failed: id == null");
        assertThat(balance).isNotNull().withFailMessage("PlayerManager#setPlayerBalance failed: balance == null");
    ...
    public void setPlayerFaction(UUID id, UUID faction) {
        assertThat(id).isNotNull().withFailMessage("PlayerManager#setPlayerFaction failed: id == null");
    ...
    public void setPlayerRank(UUID id, UUID rank) {
        assertThat(id).isNotNull().withFailMessage("PlayerManager#setPlayerRank failed: id == null");
